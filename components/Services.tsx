  ...
  return (
    <section className="lg:px-20 md:px-10 px-5 py-10 text-blue-950 ">
      ...
      <div className="flex gap-5 justify-center items-center flex-wrap lg:pt-14 md:pt-10 pt-5">
        {dummyData.map((data) => (<ServicesCard key={data.heading} {...data} />))}
        <Link  href='services' className="py-2 px-5 rounded-xl hover:text-blue-400 hover:border-blue-400 border-2  hover:bg-gray-50 cursor-pointer bg-blue-400 text-gray-50">
          learn more
        </Link>
      </div>
    </section>
