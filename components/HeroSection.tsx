...
export default function HeroSection() {
    return (
        ...
        //         <h1 className=" lg:text-3xl md:text-2xl font-medium text-xl text-blue-300">Welcome to Sommet Infra Projects Private Limited</h1>
        //         <p className="pt-4 text-justify">Lorem ipsum dolor sit amet consectetur adipisicing elit. At nulla tenetur aliquid, pariatur, rerum eum repellat quos mollitia ipsam, molestiae eaque autem ipsa!.</p>
        ...
        //     </div>
        //     <div className="lg:w-[40%] relative flex justify-center items-center lg:h-auto md:w-40 md:h-40">
        //         <Image
