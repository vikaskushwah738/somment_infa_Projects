...
export default function Road_Safety_Audit() {
    return (
        <div className="lg:w-[70%] pt-20 lg:px-0 md:px-10 px-5">
            <section>
                <h1 className="lg:text-4xl md:text-3xl text-2xl font-medium">Road Safety Audit</h1>
            ...
            <section className="py-10">
                <h2 className="lg:text-3xl md:text-2xl text-xl">Essential Attributes of Road Safety Audit</h2>
